...
They read markets, scan companies, talk to users, collect opinions, and open too many documents. The raw material keeps growing. The hard part is deciding what to continue, narrow, test, park, pause, or kill.

Founder Research OS is a workspace for that problem.
...
It is meant to be used, criticized, and improved.
